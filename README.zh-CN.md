...
在一款干净的桌面应用中掌控你的本地 Git 仓库。

提供最直接的本地使用方式：无需登录或启动后台服务，无需终端操作，就能浏览仓库、查看提交、检查改动，并管理 Releases 备份。
...
## 预览图
![Deskvio 预览图 01](./public/deskvio-preview-01.png)

![Deskvio 预览图 02](./public/deskvio-preview-02.png)
